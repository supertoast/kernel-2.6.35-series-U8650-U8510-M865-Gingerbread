...
/* Add flag that indicate if camera is initialization */
static uint8_t mt9d113_init_flag = false;
...
static struct mt9d113_i2c_reg_conf mt9d113_init_reg_config_comm[] =
{
    ...
    {0x0990, 0x0131},
    {0x098C, 0x271F},
    /* Fixup fps to solve the video division */ 
    {0x0990, 0x033f},
...
{
	long rc = 0;
    /* Delete read version id, it read before this function */
	...
	case CAMERA_WB_AUTO:
        ...
        /* Fixup fps to solve the video division */ 
        if(0 > (rc = mt9d113_i2c_write_w( 0x0990, 0x033f))){return rc;} // MCU_DATA_0
...
{ 
    ...
    /* Delete read model id, it read before this function */
                       ...
                       enum mt9d113_setting_t    rt)
{
    ...
    switch (rupdate)
    {
        ...
        case REG_INIT:
            ...
            CDBG("mt9d113_setting,mt9d113_version_id  = %d\n", mt9d113_version_id);
            if(HW_MT9D113_VER_2 == mt9d113_version_id)
            {
            ...
            CDBG("mt9d113_setting,mt9d113_mode_id  = %d\n", mt9d113_mode_id);
...
static int mt9d113_probe_init_sensor(const struct msm_camera_sensor_info *data)
{
    ...
    if(false == mt9d113_init_flag)
    {
        ...
        mt9d113_i2c_write_w(0x0028, 0x00);
        ...
        if(SUNNY_MODE_ID == mt9d113_mode_id)
        {
            strncpy((char *)data->sensor_name, "23060038XF-MT-S", strlen("23060038SF-MT-S"));
        }
        else if(LITEON_MODE_ID == mt9d113_mode_id)
        {
            strncpy((char *)data->sensor_name, "23060038XF-MT-L", strlen("23060038SF-MT-L"));
        }
        else
        {
            strncpy((char *)data->sensor_name, "23060038XF-MT-B", strlen("23060038SF-MT-B"));
        }
