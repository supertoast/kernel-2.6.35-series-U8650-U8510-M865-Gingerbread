...
static int ofn_delay[ARRAY_LEN] = {0,4,9,14,19};
static int index = 2;
...
static u8 avago_OFN_powerup(struct i2c_client *client )
{
	...
	ret = i2c_smbus_write_byte_data(client, ADBM_A320_OFN_ENGINE_ADDR, 0xa4);  //disable speed switch
	ret = i2c_smbus_write_byte_data(client, ADBM_A320_OFN_RESOLUTION_ADDR, 0x1); //250cpi
	ret = i2c_smbus_write_byte_data(client, ADBM_A320_OFN_SPEED_CONTROL_ADDR, 0x04); 
	...
	ret = i2c_smbus_write_byte_data(client, ADBM_A320_OFN_FPD_CTRL_ADDR, 0x50); 
	//ret = i2c_smbus_write_byte_data(client, ADBM_A320_OFN_ORIENTATION_CTRL_ADDR,0x81);
