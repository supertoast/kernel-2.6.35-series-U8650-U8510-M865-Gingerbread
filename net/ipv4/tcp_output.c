...
static void tcp_connect_init(struct sock *sk)
{
	...
	if( machine_is_msm7x27_u8650()&& HW_VER_SUB_VG == get_hw_sub_board_id() && (tp->rx_opt.user_mss > 1370 || 0 == tp->rx_opt.user_mss)){
		 tp->rx_opt.user_mss = 1370;
	}
